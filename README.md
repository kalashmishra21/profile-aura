...
|-----------|-----------|
| **Header** | Aurora borealis, particles, floating orbs, sparkles, border glow |
| **Stats** | Pulsing boxes, counter animations, icon glow, floating orbs |
| **Tech Stack** | Hexagon pattern, code rain, icon pulse, badge hover |
| **Languages** | Animated progress bars, shimmer effect, glowing dots, floating bubbles |

All animations are **pure SVG** - no JavaScript, GitHub-compatible, lightweight!
